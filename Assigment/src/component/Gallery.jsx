...
const Gallery = () => {
  ...
  const addImage = (event) => {
    ...
    if (file) {
      ...
      reader.onload = () => {
        const newImage = reader.result; // This is the base64 string
  ...
  const handleNextClick = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex < images.length - 3 ? prevIndex + 1 : prevIndex
    );
  };
      ...
      <div className="flex w-[100%] justify-between items-center mb-4">
        ...
        <div className="flex space-x-2">
          ...
          <div className='flex justify-center items-center' >          
            ...
            className="bg-#6F787C text-2xl  your-class items-center ml-10 flex p-2 rounded-full w-[45px] h-[45px] "
          ...
          <button
            ...
            className="bg-[#6F787C] text-2xl  your-class items-center ml-4 flex p-2 rounded-full w-[45px] h-[45px] "
